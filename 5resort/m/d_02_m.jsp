...
<script>
	function submitform(mode){
		myform2.action = "d_02_write_m.jsp";	//updateDB로 myform 데이터 전송
		myform2.submit();
		}
</script>
   <style type="text/css">
...
<body>
<center>
   <h1 style="color: #ffffff; padding-top:50px;"><center>예약하기</center></h1>
<%
...
<table border=1 cellspacing=0 class="text_box5">
	<tr>
		<td width=80 align=center>성명</td>
		<td><input type="text" name="name" value="" style="width:200px"></input></td>
	</tr>
	<tr>
		<td align=center>예약일자</td>
		<td><input type="date" name="resvdate" value="<%= key %>"  min="<%=today%>" max="<%=release_Dt_start%>"  style="width:200px"></input></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="addr" value="" style="width:200px"></input></td>
	</tr>
	<tr>
		<td align=center>전화번호</td>
		<td><input type="text" name="telnum" value="" style="width:200px"></input></td>
	</tr>
	<tr>
		<td align=center>입금자명</td>
		<td><input type="text" name="in_name" value="" style="width:200px"></input></td>
	</tr>
	<tr>
		<td align=center>남기실말</td>
		<td><input type="text" name="comment" value="" style="width:200px"></input></td>
	</tr>
</table>
<table border=0 cellspacing=0>
<tr>
	<td align=right width='280px'><input type="button" value="예약하기" OnClick="submitform('write')"></input></td> <!-- 투표하기 버튼 -->
</tr>
</table>
</form>
</center>
