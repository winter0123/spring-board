...
<%
	...
	String sql = "select count(*) from 5reply where parent =" + number1+";";
...
<%   
	...
	String sql1="delete from 5reply where id = " + number1;	//받아온 학번으로 mysql에 delete 삭제문 돌림
		
	stmt1.executeUpdate( sql1 );											//삭제문 실행
   }
	ResultSet rset = stmt.executeQuery("select*from 5reply;");		//삭제후 업데이된 데이터 출력을 위해 다시 examtable2 선택
