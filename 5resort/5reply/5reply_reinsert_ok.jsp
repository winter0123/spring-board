...
<%
	...
	String originalnum = request.getParameter("originalnum");
		...
		String sql = "SELECT rootid, relevel, recnt FROM 5reply WHERE id=" + vkey;
		...
		sql = "UPDATE 5reply SET recnt=recnt+1 where rootid="+rootid+" and recnt>"+recnt;
		stmt.executeUpdate(sql);
		
		
		Statement stmt1 = conn.createStatement();
		String sql1="";
		sql1 = "insert into 5reply(title, date, content, rootid, relevel, recnt, parent) values('[re]"+eachtitle+"', date(now()),'"+eachcontent+"',"+rootid+","+(relevel+1)+","+(recnt+1)+","+vkey+");";
